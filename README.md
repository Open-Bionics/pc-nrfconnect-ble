...
1. Ensure this repository is saved within `C:\Users\<username>\.nrfconnect-apps\local\`.
2. Follow the *Compiling* steps from here https://nordicsemiconductor.github.io/pc-nrfconnect-docs/app_development
